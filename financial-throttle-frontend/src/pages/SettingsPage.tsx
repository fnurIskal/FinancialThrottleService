...
const defaults: AppSettings = {
  ...
  useDummyData: true,
  financialApiUrl:
    "https://api.example.com/service-financialtransactionhub-test/",
      ...
      <div className="p-6 space-y-5 overflow-y-auto flex-1">
        ...
        <div className="card space-y-5">
          ...
          <div className="flex items-center justify-between">
            ...
            <Toggle
              checked={settings.useDummyData}
              onChange={(v) => set("useDummyData", v)}
            />
          </div>
        </div>
