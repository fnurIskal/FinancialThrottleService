...
public partial class RasStaj107Context : DbContext
{
    public RasStaj107Context()
    {
    }

    public RasStaj107Context(DbContextOptions<RasStaj107Context> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=localhost;Database=RAS_STAJ107;User Id=sqlserver;Password=REMOVED_SECRET;TrustServerCertificate=True;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<FinancialsAnnouncementDate>(entity =>
        {
            entity.HasKey(e => new { e.SecurityId, e.Quarter, e.TemplateId, e.IsOriginal }).HasName("PK__Financia__0451149F13091687");
        ...
        {
            entity.HasKey(e => new { e.SecurityId, e.Quarter, e.TableTemplateId, e.ItemQuarterlyNoteCode }).HasName("PK__Quarterl__606E2B0409CA7AD4");
        ...
        {
            entity.HasKey(e => new { e.SecurityId, e.Quarter, e.TableTypeId, e.TemplateId, e.Order }).HasName("PK__Quarterl__2F21AE0E51594DE8");
        ...
        {
            entity.HasKey(e => new { e.SecurityId, e.Quarter, e.TableTemplateId, e.ItemQuarterlyNoteCode }).HasName("PK__Quarterl__606E2B045352B2B1");
