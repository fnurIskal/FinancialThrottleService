...
public partial class Ras32501Context : DbContext
{
    public Ras32501Context()
    {
    }

    public Ras32501Context(DbContextOptions<Ras32501Context> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=localhost;Database=RAS_32501;User Id=sqlserver;Password=REMOVED_SECRET;TrustServerCertificate=True;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<FinancialsAnnouncementDate>(entity =>
        {
            entity.HasKey(e => new { e.SecurityId, e.Quarter, e.TemplateId, e.IsOriginal }).HasName("PK__Financia__0451149FBF53B877");
        ...
        {
            entity.HasKey(e => new { e.SecurityId, e.Quarter, e.TableTemplateId, e.ItemQuarterlyNoteCode }).HasName("PK__Quarterl__606E2B04F57A8E5D");
        ...
        {
            entity.HasKey(e => new { e.SecurityId, e.Quarter, e.TableTypeId, e.TemplateId, e.Order }).HasName("PK__Quarterl__2F21AE0E086B22D1");
        ...
        {
            entity.HasKey(e => new { e.SecurityId, e.Quarter, e.TableTemplateId, e.ItemQuarterlyNoteCode }).HasName("PK__Quarterl__606E2B041BD90ADE");
